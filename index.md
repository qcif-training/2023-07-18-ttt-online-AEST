...
humandate: "July 18-21, 2023"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00am to 1:00pm AEST each day"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2023-07-18      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2023-07-21        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Liz Stokes","Mark Crowe"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
...
eventbrite: "649118951257"         # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
locations:
  - venue: "Online"
